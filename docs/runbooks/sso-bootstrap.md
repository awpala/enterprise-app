...
| AWS | Amazon Cognito user pools with optional Google, OIDC, or SAML federation | [AWS deployment workbook](../workbooks/aws-deployment-workbook.md#3-authentication-and-client-parity) |
