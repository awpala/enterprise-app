...
| AWS | Amazon Cognito with required Google and Microsoft/Outlook federation | [AWS deployment workbook](../workbooks/aws-deployment-workbook.md#3-authentication-and-client-parity) |
