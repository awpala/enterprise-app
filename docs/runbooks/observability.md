...
| AWS | OTLP to the colocated ADOT collector, then CloudWatch and X-Ray | [AWS deployment workbook](../workbooks/aws-deployment-workbook.md#10-observability-and-operational-evidence) |
