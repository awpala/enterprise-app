...
#
# Usage (CI): called only by an explicitly Azure-targeted workflow.
...
# ---------------------------------------------------------------------------
ACR_NAME=$(terraform -chdir="${GITHUB_WORKSPACE:-/workspace}/infra/azure" output -raw acr_name)
