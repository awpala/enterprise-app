...
# and locally via `eval "$(bash docs/runbooks/scripts/azure-source-sso-env.sh production)"`.
...
# --- Guest-mode failsafe -------------------------------------------------
# Disabled by default in every cloud and environment. Set true only for an
# explicitly approved, temporary demo deployment; never for customer data.
